  ...
  return (
    <div className="rounded-3xl border border-border/40 bg-surface p-6 shadow-sm flex flex-col gap-4">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <div className="text-[12px] font-bold uppercase tracking-[0.1em] text-navy">Ana səhifə arxa fon şəkli</div>
          {loading ? (
        ...
        {!loading && (
          <div className="relative size-16 shrink-0 overflow-hidden rounded-lg border border-border/40 bg-surface-tertiary">
            <Image
